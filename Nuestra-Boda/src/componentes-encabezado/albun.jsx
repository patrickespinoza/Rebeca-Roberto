        ...
        style={{
          background: `
            ...
            linear-gradient(
              ...
              transparent 0%,
              transparent 37%,
              rgba(128,111,100,0.045) 38%,
              transparent 40%,
              transparent 67%,
              rgba(183,154,98,0.03) 68%,
              transparent 70%
            ),
            linear-gradient(
              180deg,
        ...
        >
          ...
          <motion.button
            ...
            style={{
              ...
              boxShadow: "0 12px 28px rgba(36,28,24,0.14)",
            }}
            whileHover={{
              y: -2,
                ...
                >
                  ...
                  >
                    ...
                    <div
                      ...
                      "
                      style={{
                        backgroundColor: "rgba(183,154,98,0.38)",
                      }}
                    />
                      ...
                      <motion.button
                        ...
                        style={{
                          color: copied
                            ...
                            : palette.ink,
                          borderColor: "rgba(183,154,98,0.38)",
                        }}
                        whileHover={{
                          backgroundColor: palette.paper,
                        }}
                  ...
                  >
                    ...
                    <div
                      ...
                      style={{
                        borderColor: "rgba(183,154,98,0.34)",
                        boxShadow: "0 12px 30px rgba(36,28,24,0.08)",
                      }}
                    >
                      <img
                        src="/qr.png"
